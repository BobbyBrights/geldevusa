...
require_once( S_ROOT . "/php/header_tweets/twitteroauth/twitteroauth/twitteroauth.php");
...
function get_social_media_center_tweet(
    // Function parameters.
    $twitter_user_id,
    ...
    $consumerkey         = "JfLlefcrmlSKHV8QeUxICRyZk";
    $consumersecret      = "XidRMlsh4bcxnHFKXrDXNrQXeGODsGZzGHFfAOZqx4uvH86NTv";
    $accesstoken         = "2161726064-9VUlGgp9Bn7BoYgOE65K6okVVLhdHz8E52IDcY8";
    $accesstokensecret   = "TirxouVi1BilhOcU4JdGRthvQfoanRcPsutKobzF2Mbkr";
        ...
        if($connection){
            ...
            if (count($get_tweets)) {
                ...
                foreach($get_tweets as $tweet) {
                    ...
                    $twitter_link .= '<a href="http://twitter.com/'.$twitter_user_id.'">';
                ...
                $file = fopen(S_ROOT . $cache_file, 'w');
...
get_social_media_center_tweet('gl0bal_lighting');