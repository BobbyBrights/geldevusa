<link rel="stylesheet" property="stylesheet" type="text/css" href="/pages/ceramatek/grid/objects/45W/css/ceramatek_grid_45W_rollover.css" >


    <img src="/pages/ceramatek/grid/objects/45W/img/rollover/background.png"

         id="ceramatek_grid_45W_rollover_background" alt="ceramatek_grid_45W_rollover_background">
    <div id="ceramatek_grid_45W_rollover_container">

    <div id="ceramatek_grid_45W_rollover_top_container">
        <span class="ceramatek_grid_45W_rollover_text" id="ceramatek_grid_45W_rollover_top_header_text">
    ...
    <div id="ceramatek_grid_45W_rollover_bottom_container">
        <img src="/pages/ceramatek/grid/objects/45W/img/rollover/15GEL_03_05_RetrofitDial_45W.png"
             id="ceramatek_grid_45W_rollover_dial" alt="ceramatek_grid_45W_rollover_dial">
    </div>
</div>