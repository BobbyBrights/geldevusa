<link rel="stylesheet" property="stylesheet" type="text/css" href="/pages/ceramatek/indepth/140W/css/ceramatek_140W.css" >


<span class="ceramatek_140W_header_text">
    140 W CeramaTek&reg; Retrofit Kit
</span>

<div id="ceramatek_140W_side_bar">
    <img src="/pages/ceramatek/indepth/140W/img/side_menu/product.png"
         id="ceramatek_140W_side_bar_product" alt="ceramatek_140W_side_bar_product" >

    <span class="ceramatek_140W_header_text" id="ceramatek_140W_lamp_wire_diagram_header">
        Lamp Wire Diagram
    </span>
    <img src="/pages/ceramatek/indepth/140W/img/side_menu/lamp_wire_diagram.png"
         id="ceramatek_140W_side_bar_lamp_wire_diagram" alt="ceramatek_140W_side_bar_lamp_wire_diagram" >

    <span class="ceramatek_140W_header_text" id="ceramatek_140W_ballast_wire_diagram_header">
        Ballast Wire Diagram
    </span>
    <img src="/pages/ceramatek/indepth/140W/img/side_menu/ballast.png"
         id="ceramatek_140W_side_bar_ballast" alt="ceramatek_140W_side_bar_ballast" >



    <span class="ceramatek_140W_header_text" id="ceramatek_140W_adaptors_header">
       Adaptors
    </span>
    <img src="/pages/ceramatek/indepth/140W/img/side_menu/base_adaptor.png"
         id="ceramatek_140W_side_bar_base_adaptor" alt="ceramatek_140W_side_bar_base_adaptor" >
</div>

<div id="ceramatek_140W_right_container">
    <div id="ceramatek_140W_right_lamp_char_container">


        <img src="/pages/ceramatek/indepth/140W/img/right_container/lamp_char_bg.png"
    ...
    <img src="/pages/ceramatek/indepth/140W/img/right_container/lamp_char_graphs.png"
         id="ceramatek_140W_right_lamp_char_graphs" alt="ceramatek_140W_right_lamp_char_graphs" >
    ...
    <div id="ceramatek_140W_right_lamp_phys_details_container">


        <img src="/pages/ceramatek/indepth/140W/img/right_container/lamp_phys_details_bg.png"
             id="ceramatek_140W_right_lamp_phys_bg" alt="ceramatek_140W_right_lamp_phys_bg" >
        <div class="ceramatek_140W_table_header_text ceramatek_140W_table_header_container">
        ...
        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_5">
            <span class="ceramatek_140W_table_col_1"> Arc Tube Material  </span>
            <span class="ceramatek_140W_table_col_3"> Ceramic (PCA) </span>
            <span class="ceramatek_140W_table_col_5"> Ceramic (PCA) </span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_6">
            <span class="ceramatek_140W_table_col_1"> Bulb Finish  </span>
            <span class="ceramatek_140W_table_col_3"> Clear </span>
            <span class="ceramatek_140W_table_col_5"> Clear </span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_7">
            <span class="ceramatek_140W_table_col_1"> Bulb / Shroud Temperature  </span>
            <span class="ceramatek_140W_table_col_3"> 400&deg; (max) </span>
            <span class="ceramatek_140W_table_col_5"> 550&deg; (max) </span>
        </div>
...
<div id="ceramatek_140W_right_lamp_electric_details_container">


    <img src="/pages/ceramatek/indepth/140W/img/right_container/lamp_electrical_spec_bg.png"
         id="ceramatek_140W_lamp_electrical_spec_bg" alt="ceramatek_140W_right_llamp_electrical_spec_bg" >
    <div class="ceramatek_140W_table_header_text ceramatek_140W_table_header_container">
    ...
    <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_6">
        <span class="ceramatek_140W_table_col_1"> Ignition Time  </span>
        <span class="ceramatek_140W_table_col_5"> 3 Seconds (max) </span>
    </div>

    <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_7">
        <span class="ceramatek_140W_table_col_1"> Run-up time 90%  </span>
        <span class="ceramatek_140W_table_col_5"> 1 Minute (max) </span>
    </div>

    <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_8">
        <span class="ceramatek_140W_table_col_1"> re-ignition time  </span>
        <span class="ceramatek_140W_table_col_5"> 9 Minutes (max) </span>
    </div>
</div>
    ...
    <div id="ceramatek_140W_right_ballast_details_container">


        <img src="/pages/ceramatek/indepth/140W/img/right_container/ballast_specs_bg.png"
             id="ceramatek_140W_right_ballast_specs_bg" alt="ceramatek_140W_right_ballast_specs_bg" >
        <div class="ceramatek_140W_table_header_text ceramatek_140W_table_header_container">
            <span> Lamp Electrical Specifications </span>
        </div>
        ...
        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_3">
            <span class="ceramatek_140W_table_col_1">  Mounting Distance </span>
            <span class="ceramatek_140W_table_col_5">  Up to 16 feet (standard)</span>
        </div>
        ...
        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_5">
            <span class="ceramatek_140W_table_col_1"> Ignition Voltage </span>
            <span class="ceramatek_140W_table_col_5"> 4kV </span>
        </div>
        ...
        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_7">
            <span class="ceramatek_140W_table_col_1">  Input Current Frequency </span>
            <span class="ceramatek_140W_table_col_5">  50 / 60 Hz</span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_8">
            <span class="ceramatek_140W_table_col_1">  Input Surge Protection </span>
            <span class="ceramatek_140W_table_col_5">  7kA, 1.5kV </span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_9">
            <span class="ceramatek_140W_table_col_1">  Power Factor </span>
            <span class="ceramatek_140W_table_col_5">  95% </span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_10">
            <span class="ceramatek_140W_table_col_1">  Efficiency </span>
            <span class="ceramatek_140W_table_col_5">  90+% </span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_11">
            <span class="ceramatek_140W_table_col_1">  Max Case Temperature </span>
            <span class="ceramatek_140W_table_col_5">  85&deg; C</span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_12">
            <span class="ceramatek_140W_table_col_1">  Ambient Temperature </span>
            <span class="ceramatek_140W_table_col_5">  -20&deg;C... +55&deg;C</span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_13">
            <span class="ceramatek_140W_table_col_1">  Output Protection </span>
            <span class="ceramatek_140W_table_col_5">
                Full protection against arching, wire shorts, hard switching & end of life.
            </span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_14">
            <span class="ceramatek_140W_table_col_1">  Thermal Protection </span>
            <span class="ceramatek_140W_table_col_5">  Yes </span>
        </div>

        <div class="ceramatek_140W_table_text ceramatek_140W_lamp_characteristics_table_15">
            <span class="ceramatek_140W_table_col_1">  EMC </span>
            <span class="ceramatek_140W_table_col_5">  FCC Part 18 Class A</span>
        </div>
    </div>


    <div id="ceramatek_140W_right_mounting_guidelines">
...
<script> $(function(){ script_aload("/pages/ceramatek/indepth/140W/js/ceramatek_140W.js"); }) </script>
