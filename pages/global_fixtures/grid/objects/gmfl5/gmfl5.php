<link rel="stylesheet" property="stylesheet" type="text/css" href="/pages/global_fixtures/grid/objects/gmfl5/css/gmfl5.css" >
<?php define('S_ROOT', $_SERVER['DOCUMENT_ROOT']); ?>


<div id="global_fixtures_grid_gmfl5_rollover_wrapper">
    <?php include ( S_ROOT . '/pages/global_fixtures/grid/objects/gmfl5/gmfl5_rollover.php'); ?>
</div>
...
<a href="#/global_fixtures/gmfl5" id="global_fixtures_grid_gmfl5_link">
    <div id="global_fixtures_grid_gmfl5_container">
        <img src="/pages/global_fixtures/grid/objects/gmfl5/img/bg.png"
             id="global_fixtures_grid_gmfl5_bg" alt="global_fixtures_grid_gmfl5_bg">
