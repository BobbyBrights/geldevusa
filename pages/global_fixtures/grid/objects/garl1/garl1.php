<link rel="stylesheet" property="stylesheet" type="text/css" href="/pages/global_fixtures/grid/objects/garl1/css/garl1.css" >
<?php define('S_ROOT', $_SERVER['DOCUMENT_ROOT']); ?>


<div id="global_fixtures_grid_garl1_rollover_wrapper">
    <?php include ( S_ROOT . '/pages/global_fixtures/grid/objects/garl1/garl1_rollover.php'); ?>
</div>
...
<a href="#/global_fixtures/garl1" id="global_fixtures_grid_garl1_link">
    <div id="global_fixtures_grid_garl1_container">
        <img src="/pages/global_fixtures/grid/objects/garl1/img/bg.png"
             id="global_fixtures_grid_garl1_bg" alt="global_fixtures_grid_garl1_bg">
