<link rel="stylesheet" property="stylesheet" type="text/css" href="/pages/global_fixtures/grid/objects/gmfl2/css/gmfl2.css" >
<?php define('S_ROOT', $_SERVER['DOCUMENT_ROOT']); ?>


<div id="global_fixtures_grid_gmfl2_rollover_wrapper">
    <?php include ( S_ROOT . '/pages/global_fixtures/grid/objects/gmfl2/gmfl2_rollover.php'); ?>
</div>
...
<a href="#/global_fixtures/gmfl2" id="global_fixtures_grid_gmfl2_link">
    <div id="global_fixtures_grid_gmfl2_container">
        <img src="/pages/global_fixtures/grid/objects/gmfl2/img/bg.png"
             id="global_fixtures_grid_gmfl2_bg" alt="global_fixtures_grid_gmfl2_bg">
